...
function _ensureAiStyles() {
  ...
  style.textContent = [
    ...
    '#scan-overlay { position:absolute;inset:0;z-index:300;background:rgba(255,248,245,0.97);display:none;flex-direction:column;align-items:center;justify-content:center;padding:24px; }',
    ...
    '#scan-result-img { width:160px;height:160px;object-fit:contain;border-radius:20px;background:white;box-shadow:0 8px 24px rgba(212,99,122,0.10);margin-bottom:16px; }',
    '#scan-result-info { background:white;border-radius:20px;padding:14px 16px;width:100%;box-shadow:0 4px 16px rgba(212,99,122,0.06);margin-bottom:14px; }',
